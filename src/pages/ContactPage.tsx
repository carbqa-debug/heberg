...
const GENERAL_CONTACTS = [
  { labelKey: 'contact.general', email: 'contact@photocarb.qa' },
  { labelKey: 'contact.pressMedia', email: 'media@photocarb.qa' },
  { labelKey: 'contact.partnership', email: 'partnerships@photocarb.qa' },
  { labelKey: 'contact.careers', email: 'careers@photocarb.qa' },
]
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="rounded-3xl p-7" style={{ background: 'linear-gradient(160deg, var(--color-tint-teal), var(--color-bg-secondary))' }}>
              ...
              <div className="flex flex-wrap gap-2">
                {['ISO 14064', 'CBAM Ready', 'IFRS S2', t('contact.qatarPdpl')].map(b => (
                  <span
                    key={b}
            ...
            <div className="bg-[var(--color-surface)] rounded-[calc(1.5rem-1.5px)] p-8 lg:p-10">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <Field label={t('contact.workEmail')} name="email" type="email" required />
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <Field label={t('contact.callTime')} name="callTime" type="datetime-local" />
                  </div>
                  ...
                  {status === 'error' && (
                    <p className="text-[13px] text-center font-medium" style={{ color: 'var(--color-error, #DC2626)', fontFamily: 'var(--font-body)' }}>
                      {errorMsg}
                    </p>
                  )}
