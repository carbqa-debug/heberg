...
import { IconFactory, IconBrick, IconGear, IconPlane } from './icons'
import { useLang } from '../i18n/LanguageContext'

const SECTORS = [
  { id: 'lng', labelKey: 'sector.lng.label', icon: IconFactory, headlineKey: 'sector.lng.headline', bodyKey: 'sector.lng.body', metric: '€4.20/t', metricLabelKey: 'sector.lng.metricLabel', statKey: 'sector.lng.stat', color: 'var(--color-primary)', bg: 'var(--color-bg-secondary)' },
  { id: 'cement', labelKey: 'sector.cement.label', icon: IconBrick, headlineKey: 'sector.cement.headline', bodyKey: 'sector.cement.body', metric: '22%', metricLabelKey: 'sector.cement.metricLabel', statKey: 'sector.cement.stat', color: 'var(--color-lime)', bg: 'var(--color-tint-lime)' },
  { id: 'steel', labelKey: 'sector.steel.label', icon: IconGear, headlineKey: 'sector.steel.headline', bodyKey: 'sector.steel.body', metric: '35%', metricLabelKey: 'sector.steel.metricLabel', statKey: 'sector.steel.stat', color: 'var(--color-violet)', bg: 'var(--color-tint-violet)' },
  { id: 'hospitality', labelKey: 'sector.hospitality.label', icon: IconPlane, headlineKey: 'sector.hospitality.headline', bodyKey: 'sector.hospitality.body', metric: 'IFRS S2', metricLabelKey: 'sector.hospitality.metricLabel', statKey: 'sector.hospitality.stat', color: 'var(--color-primary)', bg: 'var(--color-bg-secondary)' },
]
