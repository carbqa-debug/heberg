...
const KEYWORDS = SERVICES.map(s => s.title)
const TRUST_BADGES = ['ISO 14064', 'CBAM Ready', 'IFRS S2', 'Qatar Vision 2030']

export default function Hero() {
  const [kIdx, setKIdx] = useState(0)
  const { t } = useLang()
  const headlineLines = [t('hero.titleLine1'), t('hero.titleLine2')]
