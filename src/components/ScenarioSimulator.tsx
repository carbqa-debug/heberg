  ...
  return (
    <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[var(--shadow-card)] overflow-hidden">
      <div className="p-6 pb-5 flex items-center gap-3 border-b border-[var(--color-border)]">
        ...
        <div>
          <div className="text-[11px] font-semibold tracking-[0.16em] uppercase text-[var(--color-text-secondary)]" style={{ fontFamily: 'var(--font-body)' }}>Live Simulation</div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="bg-[var(--color-bg)] rounded-xl p-3.5 text-center">
            ...
            <div className="text-[10px] text-[var(--color-text-secondary)] mt-1.5 uppercase tracking-wide" style={{ fontFamily: 'var(--font-body)' }}>Emissions</div>
          </div>
          <div className="bg-[var(--color-bg)] rounded-xl p-3.5 text-center">
            <div className="text-[24px] font-bold leading-none tabular-nums" style={{ color, fontFamily: 'var(--font-display)' }}>{cost.toFixed(0)}%</div>
            <div className="text-[10px] text-[var(--color-text-secondary)] mt-1.5 uppercase tracking-wide" style={{ fontFamily: 'var(--font-body)' }}>Cost Impact</div>
          </div>
          <div className="bg-[var(--color-bg)] rounded-xl p-3.5 text-center">
            ...
            <div className="text-[10px] text-[var(--color-text-secondary)] mt-1.5 uppercase tracking-wide" style={{ fontFamily: 'var(--font-body)' }}>Payback</div>
          </div>
        </div>
        ...
        <p className="text-[10.5px] text-[var(--color-neutral-400)] italic mt-3" style={{ fontFamily: 'var(--font-body)' }}>
          Indicative simulation. Full scenario modeling available in the Photocarb platform.
        </p>
      </div>
    </div>
  )
