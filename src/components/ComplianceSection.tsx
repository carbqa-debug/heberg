...
const REGS = [
  { num: '①', label: 'CBAM', titleKey: 'compliance.cbam.title', descKey: 'compliance.cbam.desc', deadlineKey: 'compliance.cbam.deadline', color: 'var(--color-primary)' },
  ...
  { num: '③', label: 'Qatar NCAP', titleKey: 'compliance.ncap.title', descKey: 'compliance.ncap.desc', deadlineKey: 'compliance.ncap.deadline', color: 'var(--color-lime)' },
]
