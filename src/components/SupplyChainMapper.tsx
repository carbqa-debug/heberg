...
const NODES: NodeDef[] = [
  // Upstream (left)
  {
    ...
    scope: { en: 'Scope 3 · Cat 1', ar: 'النطاق 3 · الفئة 1' },
    name: { en: 'Raw Materials', ar: 'المواد الخام' },
    lever: { en: 'Switch to recycled / low-carbon inputs and require verified supplier PCFs.', ar: 'التحوّل إلى مدخلات معاد تدويرها / منخفضة الكربون وطلب بصمات منتج موثّقة من المورّدين.' },
  },
  {
    id: 'purchasedGoods', side: 'up', left: 1, top: 21.5, ax: 22, ay: 28, icon: IconLink,
    scope: { en: 'Scope 3 · Cat 1', ar: 'النطاق 3 · الفئة 1' },
    name: { en: 'Purchased Goods', ar: 'السلع المشتراة' },
    lever: { en: 'Structured supplier data collection and hotspot-based engagement with the top 20 suppliers.', ar: 'جمع بيانات منظّم من المورّدين وإشراك قائم على النقاط الساخنة لأكبر 20 موردًا.' },
  },
  {
    id: 'inboundTransport', side: 'up', left: 1, top: 41, ax: 22, ay: 47.5, icon: IconPlane,
    scope: { en: 'Scope 3 · Cat 4', ar: 'النطاق 3 · الفئة 4' },
    name: { en: 'Inbound Logistics', ar: 'الخدمات اللوجستية الواردة' },
    lever: { en: 'Modal shift (sea/rail over air/road) and inbound load optimization.', ar: 'التحوّل النَّمَطي (بحر/سكة بدل جو/طريق) وتحسين أحمال الوارد.' },
  },
  {
    id: 'capitalGoods', side: 'up', left: 1, top: 60.5, ax: 22, ay: 67, icon: IconGear,
    scope: { en: 'Scope 3 · Cat 2', ar: 'النطاق 3 · الفئة 2' },
    name: { en: 'Capital Goods', ar: 'السلع الرأسمالية' },
    lever: { en: 'Low-carbon procurement criteria for plant and equipment purchases.', ar: 'معايير شراء منخفضة الكربون لمشتريات المصنع والمعدات.' },
  },
  {
    id: 'packaging', side: 'up', left: 1, top: 80, ax: 22, ay: 86.5, icon: IconPackage,
    scope: { en: 'Scope 3 · Cat 1', ar: 'النطاق 3 · الفئة 1' },
    name: { en: 'Packaging', ar: 'التغليف' },
    lever: { en: 'Light-weighting and recycled-content packaging with take-back schemes.', ar: 'تخفيف الوزن وتغليف بمحتوى معاد تدويره مع أنظمة استرجاع.' },
  },
  // Your operations (center pivot)
  {
    id: 'yourOps', side: 'you', left: 39.5, top: 43.5, ax: 50, ay: 50, icon: IconFactory,
    scope: { en: 'Scope 1 + 2', ar: 'النطاق 1 + 2' },
    name: { en: 'Your Operations', ar: 'عملياتك' },
    lever: { en: 'Direct emissions and purchased energy — measured live by Photocarb CO₂ Collectors.', ar: 'الانبعاثات المباشرة والطاقة المشتراة — مقيسة لحظيًا عبر مجمّعات CO₂ من فوتوكارب.' },
  },
  // Downstream (right)
  {
    id: 'outboundDistribution', side: 'down', left: 78, top: 14, ax: 78, ay: 20.5, icon: IconGlobe,
    scope: { en: 'Scope 3 · Cat 9', ar: 'النطاق 3 · الفئة 9' },
    name: { en: 'Distribution', ar: 'التوزيع' },
    lever: { en: 'Fleet electrification, route optimization and carrier emission requirements.', ar: 'كهربة الأسطول وتحسين المسارات ومتطلبات انبعاثات الناقلين.' },
  },
  {
    id: 'productUse', side: 'down', left: 78, top: 43.5, ax: 78, ay: 50, icon: IconBolt,
    scope: { en: 'Scope 3 · Cat 11', ar: 'النطاق 3 · الفئة 11' },
    name: { en: 'Use of Products', ar: 'استخدام المنتجات' },
    lever: { en: 'Improve in-use efficiency and enable fuel/feedstock switching for customers.', ar: 'تحسين الكفاءة أثناء الاستخدام وتمكين تحويل الوقود/اللقيم لدى العملاء.' },
  },
  {
    id: 'endOfLife', side: 'down', left: 78, top: 73, ax: 78, ay: 79.5, icon: IconRecycle,
    scope: { en: 'Scope 3 · Cat 12', ar: 'النطاق 3 · الفئة 12' },
    name: { en: 'End-of-Life', ar: 'نهاية العمر' },
    lever: { en: 'Design for recyclability and route materials into circular loops.', ar: 'التصميم لقابلية إعادة التدوير وتوجيه المواد إلى حلقات دائرية.' },
  },
]
...
const INDUSTRIES: Industry[] = [
  {
    id: 'steel', name: { en: 'Steel', ar: 'الصلب' }, total: 4_200_000,
  ...
  {
    id: 'cement', name: { en: 'Cement', ar: 'الإسمنت' }, total: 3_100_000,
  ...
  {
    id: 'lng', name: { en: 'LNG / Petrochemicals', ar: 'الغاز المسال / البتروكيماويات' }, total: 8_500_000,
  ...
  {
    id: 'manufacturing', name: { en: 'Manufacturing / Auto', ar: 'التصنيع / السيارات' }, total: 620_000,
  ...
  {
    id: 'food', name: { en: 'Food & Beverage', ar: 'الأغذية والمشروبات' }, total: 480_000,
  ...
  {
    id: 'retail', name: { en: 'Retail', ar: 'التجزئة' }, total: 350_000,
...
function fmt(t: number, lang: 'en' | 'ar') {
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[11.5px] font-bold text-[var(--color-text-primary)] leading-tight truncate">
                        {lang === 'ar' ? n.name.ar : n.name.en}
                      </span>
                    </div>
                    {!isYou && (
                      <div className="mt-1.5">
                        <div className="flex items-center justify-between">
                          <span className="text-[9px] text-[var(--color-text-secondary)]">{lang === 'ar' ? n.scope.ar : n.scope.en}</span>
                    ...
                    {isYou && (
                      <div className="mt-1 text-[9px] text-[var(--color-text-secondary)]">{lang === 'ar' ? n.scope.ar : n.scope.en}</div>
                    )}
                  </button>
                )
              })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="flex-1 min-w-0">
                        <span className="block text-[13px] font-semibold text-[var(--color-text-primary)] truncate">{lang === 'ar' ? n.name.ar : n.name.en}</span>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-2.5 mb-1.5">
                  ...
                  <div>
                    <div className="text-[15px] font-bold text-[var(--color-text-primary)] leading-tight" style={{ fontFamily: 'var(--font-display)' }}>{lang === 'ar' ? sel.name.ar : sel.name.en}</div>
                    <div className="text-[10.5px] text-[var(--color-text-secondary)]" style={{ fontFamily: 'var(--font-body)' }}>{lang === 'ar' ? sel.scope.ar : sel.scope.en}</div>
                  </div>
                  {sel.side !== 'you' && (
                ...
                <div className="flex items-start gap-2 rounded-xl p-3" style={{ background: 'var(--color-tint-teal)' }}>
                  ...
                  <div>
                    ...
                    <p className="text-[12.5px] text-[var(--color-text-primary)] leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>{lang === 'ar' ? sel.lever.ar : sel.lever.en}</p>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
