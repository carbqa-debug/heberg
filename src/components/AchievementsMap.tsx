...
const ACHIEVEMENTS = [
  {
    ...
    titleEn: '1st Place', titleAr: 'المركز الأول',
    locEn: 'Tunisia & Algeria', locAr: 'تونس والجزائر',
  ...
  },
  {
    ...
    titleEn: '3rd Place — Bronze', titleAr: 'المركز الثالث — برونزية',
    locEn: 'Morocco & BRICS (China)', locAr: 'المغرب وبريكس (الصين)',
  ...
  },
  {
    ...
    titleEn: 'Best Innovation Award of the Year', titleAr: 'جائزة أفضل ابتكار للعام',
    locEn: 'Kenya', locAr: 'كينيا',
  ...
  },
  {
    ...
    titleEn: 'Featured Participant', titleAr: 'مشاركة مميزة',
    locEn: 'Italy & Dubai', locAr: 'إيطاليا ودبي',
  ...
  },
  {
    ...
    titleEn: 'Headquarters & Gulf Office', titleAr: 'المقر الرئيسي والمكتب الخليجي',
    locEn: 'Sousse, Tunisia & Doha, Qatar', locAr: 'سوسة، تونس والدوحة، قطر',
...
export default function AchievementsMap() {
  ...
  const aTitle = (a: typeof ACHIEVEMENTS[number]) => lang === 'ar' ? a.titleAr : a.titleEn
  const aLoc = (a: typeof ACHIEVEMENTS[number]) => lang === 'ar' ? a.locAr : a.locEn
  const aDesc = (a: typeof ACHIEVEMENTS[number]) => lang === 'ar' ? a.descAr : a.descEn

  return (
    <section id="global-recognition" ref={ref as React.RefObject<HTMLElement>} className="bg-[var(--color-bg-secondary)] py-16 scroll-mt-20">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className={`text-center mb-10 fade-up ${visible ? 'visible' : ''}`}>
          <span className="text-[11px] font-semibold tracking-[0.2em] uppercase mb-3 block" style={{ fontFamily: 'var(--font-body)', color: 'var(--color-navy)' }}>
            {L.eyebrow}
          </span>
